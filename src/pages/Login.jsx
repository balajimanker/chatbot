...
//                 <div className="text-center space-y-2">
//                     <div className="flex justify-center mb-4">
//                         <div className="p-3 bg-[#00000020] rounded-full">
...
//                             value={email}
//                             onChange={(e) => setEmail(e.target.value)}
//                             className="mt-2! w-full border border-[#d7dfea] bg-[#f8fafc] px-3 py-2 text-base placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 md:text-sm rounded-lg"
//                         />
//                     </div>
...
//                         disabled={loading}
//                         type="submit"
//                         className="w-full py-2 flex items-center justify-center font-medium text-white bg-blue-600 hover:bg-blue-500 disabled:bg-blue-300 transition-colors shadow-lg rounded-lg"
//                     >
//                         {loading && (
//                             <Loader2 size={16} className="animate-spin mr-2" />
//                         )}
